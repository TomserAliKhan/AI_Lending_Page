      ...
      <div className="flex pt-20  flex-col  md:max-w-[650px] shadow-2xl rounded-xl   mx-4 md:mx-auto bg-white  dark:bg-black justify-center pb-5 md:pb-10">
        ...
        <div>
          ...
          className="flex flex-col  mx-auto max-w-72 md:max-w-[550px] ">
            ...
            <span className="text-sm flex items-center py-3 gap-3">
              <input type="checkbox" name="agree" onClick={()=>{
                setform((p)=>({...p,loggedIn:!form.loggedIn}))
              }}   />
          ...
          <h2 className="text-center py-4">Don't  have an account? <Link to='/sign-up' className="text-blue-500">Sign Up</Link></h2>

           <Link to='/reset-password' className= ' text-center block text-blue-500'>Forgot password</Link>
        </div>
