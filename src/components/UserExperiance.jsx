  ...
  return (
    <div>
      <div className='mx-4 sm:mx-auto'>
        <h1 className='text-3xl font-bold text-center mt-10 md:text-4xl mx-7 sm:mx-auto md:pb-4'>What our uses says</h1>
      ...
      <div className=' grid grid-cols-1 md:grid-cols-2 md:gap-4 md:mx-8 lg:mx-auto  lg:max-w-5xl '>
