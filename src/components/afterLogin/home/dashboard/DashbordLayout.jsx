...
import { setContent } from "../../../../redux/leftSlice";

const DashboardSidebar = () => (
  <div className="flex flex-col gap-3 transition-all duration-200    dark:text-gray-400">
    <h1 className="text-sm ps-6 pb-3">Main Menu</h1>
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        isActive
          ...
          : "flex  h-12  items-center border-s-4 border-transparent ps-6 gap-2 "
      }
    >
      <svg
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        isActive
          ? " flex  h-12  items-center  ps-6 gap-2 border-s-4 border-[#7a5af8] text-[#7a5af8]"
          : "flex h-12 border-s-4 border-transparent  items-center  ps-6 gap-2 "
      }
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
const DashbordLayout = () => {
  ...
  return (
    <>
      <div className="flex   ">
        <aside className="hidden lg:block lg:w-[300px]   py-5  text-[18px] dark:text-gray-400">
          <div className="lg:fixed lg:flex flex-col gap-3 ">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? " flex  h-12  items-center  ps-6 gap-2 border-s-4 border-[#7a5af8] text-[#7a5af8] "
                  : "flex h-12   items-center  ps-6 gap-2 border-s-4 border-transparent hover:border-[#7a5af8] hover:text-[#7a5af8]"
              }
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
